...
<script type="text/javascript" src="js/scorecode.js"></script>
<script type="text/javascript" src="js/islog.js"></script>

<title>welcome!${sessionScope.student.getName()}</title>
</head>
<body>	
	<br>
	<h1 style="font-family:微软雅黑">欢迎您，${sessionScope.student.getName()}！请打分：</h1>
	
	<div id="scoreform">
		<h2 style="font-family: 楷体; text-align:center">信息学院班干部期末评分表（班级同学考核部分） 
		<img src="img/huaji.jpg" style="width: 87px;height: 75px;" onclick="huaji()"></h2>
		...
		<form action="submitscore" method="post">
			...
			<table border="1" class="table table-striped table-bordered table-hover  table-condensed">
				...
				<tr>
					...
					<td>
						...
						<!-- <input  type="number" required="" step="1" min="0" max="10" name="tzs_1"  style="width: 70px;"> -->
					</td>
					<td>
			...
			<textarea  class="form-control" style="height: 175px;width: 1160px; margin: 6px auto;" name="evaluate" id="evaluatetext"></textarea>
