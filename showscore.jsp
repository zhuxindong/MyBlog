...
<title>${requestScope.student.getName()}的打分结果</title>
</head>
<body>
	<div id="tit">
		<div id="tit1">
			<h1 >${requestScope.student.getName()}的打分结果</h1>
		</div>
<!-- 		<div id="btns">
	...
	<div id="scoreform">
		...
		<form>
			...
			<table border="1" style="text-align: center;" class="table table-striped table-bordered table-hover  table-condensed">
				...
				<tr style="text-align: center;">
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getTzs_3()}</div>
					</td>
				</tr>
				<!-- 第三行 -->
				<tr>
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getTzs_4()}</div>
					</td>
				</tr>
				<!-- 第四行 -->
				<tr>
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getTzs_5()}</div>
					</td>
				</tr>
				...
				<tr style="text-align: center;">
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getBz_3()}</div>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getBz_4()}</div>
					</td>
				</tr>
				<!-- 第三行 -->
				<tr>
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getBz_5()}</div>
					</td>
				</tr>
				...
				<tr style="text-align: center;">
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getDxwy_3()}</div>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getDxwy_4()}</div>
					</td>
				</tr>
				<!-- 第三行 -->
				<tr>
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getDxwy_5()}</div>
					</td>
				</tr>
				...
				<tr style="text-align: center;">
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getXxwy_3()}</div>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getXxwy_4()}</div>
					</td>
				</tr>
				<!-- 第三行 -->
				<tr>
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getXxwy_5()}</div>
					</td>
				</tr>
				...
				<tr style="text-align: center;">
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getWtwy_3()}</div>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getWtwy_4()}</div>
					</td>
				</tr>
				<!-- 第三行 -->
				<tr>
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getWtwy_5()}</div>
					</td>
				</tr>
				...
				<tr style="text-align: center;">
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getXlwy_3()}</div>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getXlwy_4()}</div>
					</td>
				</tr>
				<!-- 第三行 -->
				<tr>
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getXlwy_5()}</div>
					</td>
				</tr>
				...
				<tr style="text-align: center;">
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getShwy_3()}</div>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getShwy_4()}</div>
					</td>
				</tr>
				<!-- 第三行 -->
				<tr>
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getShwy_5()}</div>
					</td>
				</tr>
				...
				<tr style="text-align: center;">
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getZzwy_3()}</div>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getZzwy_4()}</div>
					</td>
				</tr>
				<!-- 第三行 -->
				<tr>
					...
					<td>
						...
						<div class="scoreresult">${requestScope.score.getZzwy_5()}</div>
					</td>
				</tr>
			</table>
			<br>
			...
			<textarea  class="form-control" style="height: 175px;width: 1160px; margin: 6px auto; font-family: 华文行楷; font-size: 20px;" name="evaluate">
				${requestScope.score.getEvaluate()}
			</textarea>
